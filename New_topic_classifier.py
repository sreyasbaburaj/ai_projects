...
MODEL_ID="faceboof/bart-large-mnli"
API_URL=f"hhtps://router.huggingface.co/hf-inference/models{MODEL_ID}"
...
def main():
    ...
    while True:
        ...
        if not headline:
            print("Please type a healine (not empty).\n")
            continue
