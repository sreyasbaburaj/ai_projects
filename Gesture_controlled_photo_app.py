...
TIP=H.HandLandmark
ids={"thumbs": TIP.THUMB_TIP,"index": TIP.INDEX_FINGER_TIP,"middle": TIP.MIDDLE_FINGER_TIP,"ring": TIP.RING_FINGER_TIP, 'pinky': TIP.PINKY_TIP}
...
def apply(img, t):
    ...
    if t=="CARTOON":
        ...
        e=cv2.adaptiveThreshold(cv2.medianBlur(g,7),255,cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY)
        c=cv2.bilateralFilter(img,9,75,75)
        return cv2.bitwise_and(c,g,mask=e)
    return img
